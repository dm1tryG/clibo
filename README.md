...
| `clibo stale [-d N]` | Everything you've been neglecting across CRM (dormant contacts), ideas (open + untouched), and books (reading without recent sessions). The "haven't touched it" companion to `overdue`. |
